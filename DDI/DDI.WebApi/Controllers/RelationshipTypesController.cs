            ...
            get
            {
                if (_allFields == null)
                {
                    ...
                    _allFields = new PathHelper.FieldListBuilder<RelationshipType>()
                        .Exclude(p => p.ReciprocalTypeFemale.FemaleTypes)
                        .Exclude(p => p.ReciprocalTypeFemale.MaleTypes)
                        .Exclude(p => p.ReciprocalTypeFemale.ReciprocalTypeFemale)
                        .Exclude(p => p.ReciprocalTypeFemale.ReciprocalTypeMale)
                        .Exclude(p => p.ReciprocalTypeFemale.Relationships)
                        .Exclude(p => p.ReciprocalTypeFemale.RelationshipCategory)
                        .Exclude(p => p.ReciprocalTypeMale.FemaleTypes)
                        .Exclude(p => p.ReciprocalTypeMale.MaleTypes)
                        .Exclude(p => p.ReciprocalTypeMale.ReciprocalTypeFemale)
                        .Exclude(p => p.ReciprocalTypeMale.ReciprocalTypeMale)
                        .Exclude(p => p.ReciprocalTypeMale.Relationships)
                        .Exclude(p => p.ReciprocalTypeMale.RelationshipCategory)
