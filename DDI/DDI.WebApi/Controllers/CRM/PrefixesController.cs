...
namespace DDI.WebApi.Controllers.CRM
{
    ...
    public class PrefixesController : GenericController<Prefix>
    {
        ...
        public override IHttpActionResult GetAll(int? limit = SearchParameters.LimitMax, int? offset = SearchParameters.OffsetDefault, string orderBy = OrderByProperties.Prefix, string fields = null)
        {            
        ...
        [HttpPost]
        [Route("api/v1/prefixes")]
        public override IHttpActionResult Post([FromBody] Prefix entityToSave)
        {
