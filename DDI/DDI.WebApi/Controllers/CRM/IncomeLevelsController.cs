...
namespace DDI.WebApi.Controllers.CRM
{
    ...
    {
        public IncomeLevelsController(IService<IncomeLevel> service) : base(service) { }
        ...
        [HttpPost]
        [Route("api/v1/incomelevels")]
        public override IHttpActionResult Post([FromBody] IncomeLevel entityToSave)
        {
