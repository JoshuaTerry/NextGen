...
namespace DDI.Data.Models
{
    ...
    /// </summary>
    public abstract class BaseLinkedEntity : BaseEntity
    {

        #region Fields

        private BaseEntity _parentEntity = null;
        ...
        {
            Type parentType;
            if (BaseEntity.EntityTypeDict.TryGetValue(this.EntityType, out parentType))
            {
                var query = context.Set(parentType) as IQueryable<BaseEntity>;
