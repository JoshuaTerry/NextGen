namespace DDI.Data.Migrations.Client
{
    ...
    public partial class fixingMigration : DbMigration
    {
        public override void Up()
        {
            ...
            RenameColumn(table: "dbo.Denomination", name: "Constituent_Id", newName: "ConstituentId");
            RenameColumn(table: "dbo.Ethnicity", name: "Constituent_Id", newName: "ConstituentId");
            RenameColumn(table: "dbo.PaymentPreference", name: "Constituent_Id", newName: "ConstituentId");
            RenameIndex(table: "dbo.Denomination", name: "IX_Constituent_Id", newName: "IX_ConstituentId");
            RenameIndex(table: "dbo.Ethnicity", name: "IX_Constituent_Id", newName: "IX_ConstituentId");
                ...
                c => new
                    {
                        ...
                        SecondaryAbbreviation = c.String(maxLength: 8),
            ...
            AddColumn("dbo.Education", "SchoolCode", c => c.String());
            AddColumn("dbo.Education", "SchoolOther", c => c.String());
            AddColumn("dbo.Education", "DegreeCode", c => c.String());
            AddColumn("dbo.Education", "DegreeOther", c => c.String());
        ...
        public override void Down()
        {
            ...
            DropColumn("dbo.Education", "DegreeOther");
            DropColumn("dbo.Education", "DegreeCode");
            DropColumn("dbo.Education", "SchoolOther");
            ...
            RenameIndex(table: "dbo.Ethnicity", name: "IX_ConstituentId", newName: "IX_Constituent_Id");
            RenameIndex(table: "dbo.Denomination", name: "IX_ConstituentId", newName: "IX_Constituent_Id");
            RenameColumn(table: "dbo.PaymentPreference", name: "ConstituentId", newName: "Constituent_Id");
            RenameColumn(table: "dbo.Ethnicity", name: "ConstituentId", newName: "Constituent_Id");
            RenameColumn(table: "dbo.Denomination", name: "ConstituentId", newName: "Constituent_Id");
            ...
            CreateIndex("dbo.ConstituentEthnicity", "EthnicityId");
            CreateIndex("dbo.ConstituentEthnicity", "ConstituentId");
            CreateIndex("dbo.ConstituentDemonination", "DenominationId");
            CreateIndex("dbo.ConstituentDemonination", "ConstituentId");
            ...
            AddForeignKey("dbo.ConstituentEthnicity", "EthnicityId", "dbo.Ethnicity", "Id");
            AddForeignKey("dbo.ConstituentEthnicity", "ConstituentId", "dbo.Constituent", "Id");
            AddForeignKey("dbo.ConstituentDemonination", "DenominationId", "dbo.Denomination", "Id");
            AddForeignKey("dbo.ConstituentDemonination", "ConstituentId", "dbo.Constituent", "Id");
        }
    }
}
