...
{
    internal class SaveResult<TChangeSet, TPrincipal> : ISaveResult<TChangeSet> where TChangeSet : IChangeSet<TPrincipal>
    {
        internal SaveResult()
        {
        ...
        internal SaveResult(int affectedObjectCount): this()
        {
